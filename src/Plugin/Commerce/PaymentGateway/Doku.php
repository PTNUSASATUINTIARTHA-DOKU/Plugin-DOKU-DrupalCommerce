 ...
 *   id = "doku",
 *   label = "Doku",
 *   display_label = "Online Payment via Doku",
 *    forms = {
 *     "offsite-payment" = "Drupal\commerce_doku\PluginForm\DokuForm",
 *   },
*   modes= {
 *     "staging" = "Staging",
 ...
 * )
 */
class Doku extends OffsitePaymentGatewayBase implements DokuInterface {
  /**
   * {@inheritdoc}
   */
