 ...
 *   id = "doku_creditcard_installment_offus",
 *   label = "Doku Credit Card Installment Off Us",
 *   display_label = "Online Payment via Doku Credit Card Installment",
 *    forms = {
 *     "offsite-payment" = "Drupal\commerce_doku\PluginForm\DokuCreditCardInstallmentOffUsForm",
 *   },
*   modes= {
 *     "staging" = "Staging",
 ...
 * )
 */
class DokuCreditCardInstallmentOffUs extends OffsitePaymentGatewayBase implements DokuCreditCardInstallmentOffUsInterface {
  /**
   * {@inheritdoc}
   */
